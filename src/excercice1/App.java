...
public class App {
    public static void main(String[] args) {
        try {
            // Test Case 1: Création d'un EntierNaturel avec une valeur valide
            ...
            try {
                entier.setVal(-5); // Cela devrait lever l'exception NombreNegatifException
        ...
        try {
            // Test Case 5: Tester la création d'un EntierNaturel avec une valeur négative
            EntierNaturel entier = new EntierNaturel(-1); // Cela devrait lever l'exception NombreNegatifException
        } catch (NombreNegatifException e) {
            System.out.println("Case 5 - Erreur de création d'un EntierNaturel : " + e.getMessage());
            System.out.println("Valeur erronée : " + e.getValeurErronee());
        }
        System.out.println("-----");
        ...
        try {
            ...
            entier.decrementer(); // Cela devrait lever l'exception NombreNegatifException
        } catch (NombreNegatifException e) {
